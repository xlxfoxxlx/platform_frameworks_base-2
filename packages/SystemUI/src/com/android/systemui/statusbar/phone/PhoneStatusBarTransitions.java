...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mNetworkTraffic, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mAosipLogo, mCLogo, mMinitBattery;
    ...
    public void init() {
        ...
        mAosipLogo = mView.findViewById(R.id.aosip_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            mAosipLogo.setAlpha(newAlphaBC);
