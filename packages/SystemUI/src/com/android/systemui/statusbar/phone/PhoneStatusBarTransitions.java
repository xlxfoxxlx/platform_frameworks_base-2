...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mNetworkTraffic, mKronicLogo, mMinitBattery;
    ...
    public void init() {
        ...
        mKronicLogo = mView.findViewById(R.id.kronic_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mKronicLogo, newAlphaBC),
            ...
            mKronicLogo.setAlpha(newAlphaBC);
